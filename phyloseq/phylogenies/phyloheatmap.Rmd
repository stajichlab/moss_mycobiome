...
p3 <- ggtree(pgroup2, layout="rectangular", aes(color=group)) + 
  scale_color_manual(values = pal) + geom_tiplab(size = 1, align = TRUE, linesize = .40, offset = .38, linetype = 3, color = "black") 
...
p_heatmap <- gheatmap(p3, log_df_otu, width=.75, offset=0, 
