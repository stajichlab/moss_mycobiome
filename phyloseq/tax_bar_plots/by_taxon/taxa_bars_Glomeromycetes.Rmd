...
```{r fig.height=5, fig.width=8, fig.align="center"}
pdf("./Figures_glomeromycetes/Crust_type_Glomeromycete_Melted_Taxonomic_Composition_(Genus_level).pdf", width = 8, height = 5.8 )
...
###STEP15 Taxonomic composition Glomeromyectes (unmelted) by Crust_type
...
###STEP17 Taxonomic composition Rhizophagus (unmelted) by Crust_type
...
```{r}
sample_data(physeq.prune.rarefy.Rhizo)$Crust_type = factor(sample_data(physeq.prune.rarefy.Rhizo)$Crust_type, levels = c("SMC.ster", "SMC", "Dirt", "SMC.sub"))
...
tax_crust_type_class_rhizo_abundance <- plot_bar(physeq.prune.rarefy.Rhizo, x="Crust_type", fill = "Class")  + 
  ...
  ggtitle("Rhizophagus by Crust_type")  +
...
# Display the plot
tax_crust_type_class_rhizo_abundance

```

```{r fig.height=5, fig.width=8, fig.align="center"}

pdf("./Figures_glomeromycetes/Rhizophagus_abundance_Crust_type.pdf", width = 8, height = 5 )
tax_crust_type_class_rhizo_abundance
```

###STEP18 Taxonomic composition Glomus (unmelted) by Crust_type
...
tax_crust_type_class_glomus_abundance <- plot_bar(physeq.prune.rarefy.Glomus, x="Crust_type", fill = "Class")  + 
  geom_bar(aes(color=Species, fill=Species), stat="identity", position="stack", color="transparent") +  # Set color to "transparent" to remove borders
  theme_bw() +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  scale_fill_manual(values = c("black","#6ea8ab")) +  # Set high contrast colors 
...
# Display the plot
tax_crust_type_class_glomus_abundance

```

```{r fig.height=5, fig.width=8, fig.align="center"}

pdf("./Figures_glomeromycetes/glomus_abundance_Crust_type.pdf", width = 8, height = 5 )
tax_crust_type_class_glomus_abundance
```
