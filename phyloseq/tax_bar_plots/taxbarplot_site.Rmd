...
Create levels of phyla represented in barplot. Levels appear on the barplot in the order they are listed. REMEMBER FIX MANUALLY FOR EVERY Iteration

```{r}
data_glom.fun$Class <- factor(data_glom.fun$Class, levels = c("Agaricomycetes", "Dothideomycetes", "Sordariomycetes", "Microbotryomycetes", "Unknown", "Eurotiomycetes","Saccharomycetes", "Rhizophlyctidomycetes", "Glomeromycetes", "Tremellomycetes","Lecanoromycetes","Pezizomycetes","Leotiomycetes","<1% abund."))
```
...
```{r}
png("./Figures/Fungal_Taxonomic_Composition_(Class_level)_by_Site.png", units="in", width = 5.8, height = 5.8, res = 300 )
taxcom_layer_pl
dev.off()
```
