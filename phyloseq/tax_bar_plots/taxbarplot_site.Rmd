...
author: "Nat Pombubpa and a bit by Kian Kelly"
...
```{r}
data_glom.fun$Class <- factor(data_glom.fun$Class, levels = c("Agaricomycetes", "Dothideomycetes", "Pezizomycetes", "Sordariomycetes", "Unknown", "Microbotryomycetes","Eurotiomycetes", "Rhizophlyctidomycetes", "Saccharomycetes", "Glomeromycetes","Tremellomycetes","Lecanoromycetes","Leotiomycetes","Basidiobolomycetes","Mortierellomycetes","<1% abund."))
```
...
```{r}
data_glom.fun$Site = factor(data_glom.fun$Site, levels = c("AB", "CIMA", "ODLO", "TP","TP2","GMT"))
```
