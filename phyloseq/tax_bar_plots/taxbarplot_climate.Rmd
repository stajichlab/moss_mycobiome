...
#Fungal taxonomic barplot by Climate
...
taxcom_layer_pl = ggplot(data = data_glom.fun, mapping = aes_string(x = "Climate" ,y = "Abundance", fill = "Class" )) + 
  geom_bar(stat="identity", position="fill") + 
  ggtitle("Fungal Taxonomic Composition (Class level) by Climate")+
...
```{r}
png("./Figures/Fungal_Taxonomic_Composition_(Class_level)_by_Climate.png", units="in", width = 5.8, height = 5.8, res = 300 )
taxcom_layer_pl
dev.off()
```
