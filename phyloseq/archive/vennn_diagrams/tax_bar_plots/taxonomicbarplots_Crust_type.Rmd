...
```{r}
data_glom.fun$Class <- factor(data_glom.fun$Class, levels = c("Dothideomycetes", "Agaricomycetes", "Microbotryomycetes", "Pezizomycetes", "Eurotiomycetes", "Unknown", "Sordariomycetes", "Tremellomycetes", "Mortierellomycetes", "Cystobasidiomycetes", "<1% abund."))
```
