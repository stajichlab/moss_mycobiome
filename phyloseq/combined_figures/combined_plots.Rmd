...
f <- ggvenn_pq(physeq.prune, fact = "Climate", label_alpha = 0, category.names = c("Coastal", "Colorado\nDesert", "Mojave Desert")) +
  ggplot2::scale_fill_distiller(palette = "BuPu", direction = 1)

d <- ggvenn_pq(physeq.prune, fact = "Substrate", label_alpha = 0, category.names = c("Bare\nSoil", "Subsurface", "Surface Sterile", "Moss\nCrust")) +
  ggplot2::scale_fill_distiller(palette = "BuPu", direction = 1)
...
physeq.prune.rarefy.plot.richness.Substrate = plot_richness(physeq.prune.rarefy, x="Substrate", color=("Substrate"), measures=c("Observed")) + geom_boxplot() + stat_compare_means(method = "anova", label.y = 25) + stat_compare_means(aes(label=..p.signif..), method = "t.test", ref.group = "Dirt", label.y = 50, hide.ns = TRUE) + theme_bw() + theme(plot.title = element_text(hjust = 0.5)) + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + scale_color_manual(values = friendly_pal("zesty_four")) 
