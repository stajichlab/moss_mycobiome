...
crust_type_venn <- ps_venn(physeq.prune.rarefy, "Crust_type", quantities = list(type=c("counts"), font = 1), labels = list(cex = 1.5), col = "black", fill = c(values = Dali), relative = TRUE)
...
png("./figures_glom/Crust_type_venn.png", units="in", width = 5.8, height = 5.8, res = 300 )
crust_type_venn
dev.off()
...
png("./figures_glom/climate_venn.png", units="in", width = 5.8, height = 5.8, res = 300 )
climate_venn
dev.off()
...
venn_moss <- ps_venn(physeq.prune.rarefy.crust_type, "Crust_type", quantities = list(type=c("counts"), font = 1), labels = list(cex = 1.5), col = "black", fill = c(values = Dali), relative = TRUE)
