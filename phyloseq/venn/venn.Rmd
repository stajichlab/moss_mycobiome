...
png("./figures/Substrate_venn.png", units="in", width = 6.3, height = 5.8, res = 300 )
Substrate_venn
dev.off()
...
png("./figures/site_venn.png", units="in", width = 5.8, height = 5.8, res = 300 )
site_venn
dev.off()
...
climate_venn <- ps_venn(physeq.prune.rarefy, "Climate", quantities = list(type=c("counts"), font = 1), labels = list(cex = 1.5), col = "black", fill = c(values = Dali), relative = TRUE)
...
png("./figures/climate_venn.png", units="in", width = 5.8, height = 5.8, res = 300 )
climate_venn
dev.off()
...
png("./figures/plant_venn.png", units="in", width = 5.8, height = 5.8, res = 300 )
plant_venn
dev.off()
...
png("./figures/layer_venn.png", units="in", width = 5.8, height = 5.8, res = 300 )
venn_layer
dev.off()
...
png("./figures/moss_venn.png", units="in", width = 5.8, height = 5.8, res = 300 )
venn_moss
dev.off()
