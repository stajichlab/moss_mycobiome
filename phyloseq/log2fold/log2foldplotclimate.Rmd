...
otu_tab <- otu_table(physeq.prune.rarefy)
...
physeq.prune.rarefy.Climate_simple <- merge_phyloseq(physeq.prune.rarefy, otu_tab_modified)

# Check the modified phyloseq object
physeq.prune.rarefy.Climate_simple
...
DEseq_Climate_simple <- phyloseq_to_deseq2(physeq.prune.rarefy.Climate_simple, ~ Climate_simple)
...
sigtab = cbind(as(sigtab, "data.frame"), as(tax_table(physeq.prune.rarefy.Climate_simple)[rownames(sigtab), ], "matrix"))
head(sigtab)
```
