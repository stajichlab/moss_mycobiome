...
otu_tab <- otu_table(physeq.prune.rarefy.crust_type)
...
physeq.prune.rarefy.crust_type <- merge_phyloseq(physeq.prune.rarefy.crust_type, otu_tab_modified)
...
DEseq_substrate <- phyloseq_to_deseq2(physeq.prune.rarefy.crust_type, ~ Crust_type)
